...
import (
	...
	"github.com/doanac/go-dgclient/v1/sotatoml"
)

// GetTlsConfig will create the proper tls.Config for mTLS access to a
// web service using Factory PKI issued keys. This function can handle
// a device that uses file-based or hsm-based keys.
